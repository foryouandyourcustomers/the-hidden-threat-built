...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/16-d3562ca2.js')),
			__memo(() => import('./chunks/17-a6cf809b.js')),
			__memo(() => import('./chunks/18-f18f4806.js'))
		],
		routes: [
			{
				id: "/(pages)",
