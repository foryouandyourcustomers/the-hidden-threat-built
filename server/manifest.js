...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/16-3074d78c.js')),
			__memo(() => import('./chunks/17-b98621c0.js')),
			__memo(() => import('./chunks/18-97fb7a19.js'))
		],
		routes: [
			{
				id: "/(pages)",
