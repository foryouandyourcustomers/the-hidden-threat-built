...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/13-441bc396.js')),
			__memo(() => import('./chunks/14-666f6f50.js')),
			__memo(() => import('./chunks/15-2709469d.js'))
		],
		routes: [
			{
				id: "/(pages)",
