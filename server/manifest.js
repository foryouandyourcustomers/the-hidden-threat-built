...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/13-618374da.js')),
			__memo(() => import('./chunks/14-ff6018ec.js')),
			__memo(() => import('./chunks/15-3e8e41d1.js'))
		],
		routes: [
			{
				id: "/(pages)",
