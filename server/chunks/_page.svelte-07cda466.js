...
import { I as Item } from './Item-53c609f4.js';
...
const AttackStage = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $canAttack, $$unsubscribe_canAttack;
  let $startedAttacking, $$unsubscribe_startedAttacking;
  const { machine: machine2 } = getGameContext();
  const canAttack = useSelector(machine2.service, () => {
    return false;
  });
  $$unsubscribe_canAttack = subscribe(canAttack, (value) => $canAttack = value);
  ...
  $$unsubscribe_canAttack();
  $$unsubscribe_startedAttacking();
  return `${validate_component(Action, "Action").$$render($$result, { disabled: !$canAttack }, {}, {
    default: () => {
...
//# sourceMappingURL=_page.svelte-07cda466.js.map
