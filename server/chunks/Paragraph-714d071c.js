import { c as create_ssr_component, e as escape, f as add_attribute, x as null_to_empty, v as validate_component, o as onDestroy, b as spread, d as escape_object } from './ssr-0f977c41.js';
import { i as is_void } from './Heading-73f1ef21.js';
...
const css$2 = {
  code: ".tooltip.svelte-pr3mgh.svelte-pr3mgh{--_offset:calc(100% + 1rem);background:#fff;border-radius:var(--radius-sm);box-shadow:0 0 10px 0 rgba(38,45,46,.25);color:#000;cursor:auto;font:var(--text-regular);font-size:var(--scale-00);max-width:30ch;opacity:0;padding:.75rem;pointer-events:none;position:absolute;scale:.97;text-transform:none;transition:all .1s ease-in-out;white-space:normal;width:-moz-max-content;width:max-content;z-index:var(--layer-top)}.tooltip.no-padding.svelte-pr3mgh.svelte-pr3mgh{padding:0}.tooltip.visible.svelte-pr3mgh.svelte-pr3mgh{opacity:1;pointer-events:inherit;scale:1}.tooltip.left.svelte-pr3mgh.svelte-pr3mgh,.tooltip.right.svelte-pr3mgh.svelte-pr3mgh{top:50%;transform:translateY(-50%)}.tooltip.bottom.svelte-pr3mgh.svelte-pr3mgh,.tooltip.top.svelte-pr3mgh.svelte-pr3mgh{left:50%;transform:translateX(-50%)}.tooltip.left.svelte-pr3mgh.svelte-pr3mgh{right:var(--_offset)}.tooltip.right.svelte-pr3mgh.svelte-pr3mgh{left:var(--_offset)}.tooltip.top.svelte-pr3mgh.svelte-pr3mgh{bottom:var(--_offset)}.tooltip.bottom.svelte-pr3mgh.svelte-pr3mgh{top:var(--_offset)}.tooltip.bottom-left.svelte-pr3mgh.svelte-pr3mgh{right:-.25rem;top:var(--_offset)}.arrow.svelte-pr3mgh.svelte-pr3mgh{--_size:0.875rem;--_offset:-0.85rem;display:block;height:.875rem;height:var(--_size);position:absolute;width:.875rem;width:var(--_size)}.tooltip.left.svelte-pr3mgh .arrow.svelte-pr3mgh,.tooltip.right.svelte-pr3mgh .arrow.svelte-pr3mgh{top:50%;translate:0 -50%}.tooltip.bottom.svelte-pr3mgh .arrow.svelte-pr3mgh,.tooltip.top.svelte-pr3mgh .arrow.svelte-pr3mgh{left:50%;translate:-50% 0}.tooltip.left.svelte-pr3mgh .arrow.svelte-pr3mgh{right:var(--_offset);rotate:-90deg}.tooltip.bottom.svelte-pr3mgh .arrow.svelte-pr3mgh{rotate:.5turn;top:var(--_offset)}.tooltip.right.svelte-pr3mgh .arrow.svelte-pr3mgh{left:var(--_offset);rotate:90deg}.tooltip.top.svelte-pr3mgh .arrow.svelte-pr3mgh{bottom:var(--_offset)}.tooltip.bottom-left.svelte-pr3mgh .arrow.svelte-pr3mgh{right:.5rem;rotate:.5turn;top:var(--_offset)}.close.svelte-pr3mgh.svelte-pr3mgh{height:1.25rem;padding:0;position:absolute;right:.3rem;top:.3rem;width:1.25rem}.close.svelte-pr3mgh svg{display:block;height:100%;width:100%}",
  map: null
};
const Tooltip = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { position = "bottom" } = $$props;
  let { click = false } = $$props;
  let { showOnCreate = false } = $$props;
  ...
  if ($$props.showOnCreate === void 0 && $$bindings.showOnCreate && showOnCreate !== void 0)
    $$bindings.showOnCreate(showOnCreate);
  ...
  return `<div role="dialog" class="${[
    "tooltip " + escape(position, true) + " svelte-pr3mgh",
    (visible ? "visible" : "") + " " + (noPadding ? "no-padding" : "")
  ].join(" ").trim()}"${add_attribute("this", tooltipElement, 0)}><button class="unstyled close svelte-pr3mgh">${validate_component(X, "CloseIcon").$$render($$result, {}, {}, {})}</button> ${slots.default ? slots.default({}) : ``} <svg class="arrow svelte-pr3mgh" width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg"><path d="M14 0H0L5.3 8.3C5.47937 8.58942 5.72965 8.82826 6.02715 8.99388C6.32465 9.1595 6.65951 9.24643 7 9.24643C7.34049 9.24643 7.67535 9.1595 7.97285 8.99388C8.27035 8.82826 8.52063 8.58942 8.7 8.3L14 0Z" fill="white"></path></svg> </div>`;
});
const css$1 = {
...
export { Actions as A, Button as B, Paragraph as P, Tooltip as T, X, Polygon as a };
//# sourceMappingURL=Paragraph-714d071c.js.map
