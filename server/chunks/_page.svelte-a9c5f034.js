import { c as create_ssr_component, a as subscribe, v as validate_component, e as escape, o as onDestroy, s as setContext, g as each, h as add_styles, f as add_attribute, i as getContext, j as compute_slots, k as createEventDispatcher, b as spread, d as escape_object, l as escape_attribute_value } from './ssr-35980408.js';
import { r as readable, w as writable } from './index2-60e1937a.js';
import { g as require_root, F as require_baseGetTag, p as requireIsObjectLike, c as requireIsObject, x as createMachine, D as interpret, y as assign, G as not, H as and, z as sharedGuards, E as isEqual, I as guardForGameEventType, B as isDefenderId, J as getUser } from './isEqual-9646daaa.js';
import { a as ITEMS, i as isDefenseItemId, b as isAttackItemId, F as FACES, c as isItemIdOfSide, C as CHARACTERS } from './constants-314b53e7.js';
...
import { F as Face } from './Face-4354298b.js';
...
class GameState {
  ...
  constructor(context) {
    ...
    this.activePlayer = this.playersInOrder[Math.floor(this.finalizedEvents.length / 2) % this.playersInOrder.length];
  ...
  getPlayer(playerId) {
    if (isDefenderId(playerId)) {
      const player = this.context.defense.defenders.find((player2) => player2.id === playerId);
      if (!player)
...
const css$i = {
  code: ".header.svelte-jnmtxx{align-items:center;background:linear-gradient(180deg,rgba(43,52,72,0),rgba(43,52,72,.663));display:flex;height:3.5rem;justify-content:space-between;overflow:hidden;padding-left:3rem;padding-right:3rem}.title.svelte-jnmtxx{font:var(--display-h2);font-size:var(--scale-4);text-transform:uppercase}",
  map: null
};
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$i);
  return `<div class="header svelte-jnmtxx"><div class="title svelte-jnmtxx" data-svelte-h="svelte-xbe4by">The hidden threat</div> ${validate_component(EmojiPicker, "EmojiPicker").$$render($$result, {}, {}, {})} </div>`;
});
const css$h = {
...
const PlayerConfigurator = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const player = useSelector(machine2.service, ({ context }) => GameState.fromContext(context).getPlayer(playerId));
...
const CollectItem = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Button, "Button").$$render($$result, { disabled: $collectableItems.length === 0 }, {}, {
    default: () => {
      return `Collect item`;
    }
  })} ${$startedCollecting ? `${each($collectableItems, (collectableItem) => {
...
const css$7 = {
  code: ".actions.svelte-14is7xv{background:#fff;left:50%;padding:1rem;position:absolute;top:50%}",
  map: null
};
const Actions = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$canPerformAction ? `<ul class="actions svelte-14is7xv"><li>${validate_component(CollectItem, "CollectItem").$$render($$result, {}, {}, {})}</li></ul>` : ``}`;
});
const css$6 = {
...
const Square = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const players = useSelector(
    ...
    ({ context }) => {
      ...
      return objectEntries(playerPositions).filter(([_, position]) => isEqual(position, coordinate)).map(([playerId]) => gameState.getPlayer(playerId));
    },
    isEqual
  );
  $$unsubscribe_players = subscribe(players, (value) => $players = value);
  ...
  return `<div class="${["square svelte-4u67jd", $isPossibleMove ? "possible-move" : ""].join(" ").trim()}"${add_styles({
    ...
    return `<div class="item svelte-4u67jd">${validate_component(Item, "Item").$$render($$result, { itemId: item.id }, {}, {})} </div>`;
  })} ${each($players, (player) => {
...
const TempActionButton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `Round: ${escape($currentRound + 1)}
...
const css$1 = {
  code: ".playing.svelte-19lwmva{grid-gap:1rem;display:grid;gap:1rem;grid-template-columns:1fr auto 20%}.board.svelte-19lwmva,.playing.svelte-19lwmva{position:relative}",
  map: null
};
const Playing = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$1);
  return `<div class="playing svelte-19lwmva"><div class="actions">${validate_component(Players, "Players").$$render($$result, {}, {}, {})} ${validate_component(TempActionButton, "TempActionButton").$$render($$result, {}, {}, {})}</div> <div class="board svelte-19lwmva">${validate_component(Board, "Board").$$render($$result, {}, {}, {})} ${validate_component(Actions, "Actions").$$render($$result, {}, {}, {})}</div> <div class="status"></div> </div>`;
});
const css = {
  code: ".game-wrapper.svelte-gtdob6{align-content:center;background:#000;display:grid;height:100%;justify-content:center;place-content:center;width:100%}.game.svelte-gtdob6{grid-gap:1rem;background:var(--color-bg);border-radius:var(--radius-sm);display:grid;gap:1rem;grid-template-rows:3.5rem 1fr;height:50.625rem;overflow:hidden;position:relative;width:90rem}@media(max-width:1439.98px) or (max-height:809.98px){.game.svelte-gtdob6{scale:.8;transform-origin:center}}@media(max-width:1199.98px) or (max-height:674.98px){.game.svelte-gtdob6{scale:.6}}.content.svelte-gtdob6{padding-right:3rem}",
  map: null
};
const Game = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  $$unsubscribe_section();
  return `<div class="game-wrapper svelte-gtdob6"> <div class="game svelte-gtdob6"${add_attribute("this", gameContainer, 0)}>${validate_component(Header, "Header").$$render($$result, {}, {}, {})} <div class="content svelte-gtdob6">${$section === "Lobby" ? `${validate_component(Lobby, "Lobby").$$render($$result, {}, {}, {})}` : `${$section === "Playing" ? `${validate_component(Playing, "Playing").$$render($$result, {}, {}, {})}` : `${$section === "Finished" ? `${validate_component(Finished, "Finished").$$render($$result, {}, {}, {})}` : `Unkown state`}`}`}</div> ${slots.overlays ? slots.overlays({}) : ``}</div> </div>`;
});
let howl;
const sprite = {
  capture: [0, 204],
...
//# sourceMappingURL=_page.svelte-a9c5f034.js.map
