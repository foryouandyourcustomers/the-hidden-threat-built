...
import { B as Board } from './Board-58cee01b.js';
import { a as Polygon, P as Paragraph, A as Actions, B as Button } from './Polygon-c9914207.js';
...
const css = {
  code: "form.svelte-4xraue{width:44rem}.field.svelte-4xraue{background:var(--color-blue-transp-760);border-radius:var(--radius-md);margin-bottom:2rem;padding:1rem 2rem}.backdrop.svelte-4xraue{bottom:-5%;position:absolute;right:-5%;rotate:-20deg;width:33rem;z-index:-1}.more-info.svelte-4xraue{margin-top:3rem}",
  map: null
};
const UsernameScreen = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Board, "Board").$$render($$result, { paddedContent: true, showFooter: true }, {}, {
    default: () => {
      return `<div class="backdrop svelte-4xraue">${validate_component(Polygon, "Polygon").$$render($$result, { color: "black" }, {}, {})}</div> ${validate_component(Heading, "Heading").$$render($$result, { separator: true }, {}, {
        info: () => {
    ...
    Usernamen werden Sie in die Lobby geleitet.`;
      ...
      })} <form method="post" class="svelte-4xraue"><div class="field svelte-4xraue">${validate_component(Heading, "Heading").$$render($$result, { centered: true }, {}, {
        default: () => {
      ...
      })}</form> <p class="more-info text-sm svelte-4xraue" data-svelte-h="svelte-1iim19c">* Weitere Informationen zum Spiel sind auf unserer <a href="/">Website</a> zufinden.</p>`;
    }
  })}`;
});

export { UsernameScreen as U };
//# sourceMappingURL=UsernameScreen-054ad03e.js.map
