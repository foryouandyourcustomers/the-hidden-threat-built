...
const TARGETED_ATTACKS = [
  {
    ...
    description: "Schleust minderwertige und gefälschte Materialien in die Lieferkette ein und sorgt dadurch für Produktionsausfälle sowieKundenbeschwerden."
  },
  {
...
class GameState {
  ...
  getActiveGlobalAttacks() {
    ...
    return this.context.globalAttacks.slice(0, attackCount).map((attackIndex) => GLOBAL_ATTACKS[attackIndex]);
  }
}
const sharedGuards = {
  // TODO
