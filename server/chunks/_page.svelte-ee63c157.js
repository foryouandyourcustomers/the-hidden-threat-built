...
import { r as require_root, g as require_baseGetTag, h as requireIsObjectLike, j as requireIsObject, c as createMachine, d as interpret, a as assign, n as not, s as sharedGuards, e as isEqual, F as FACES, i as isDefenderId } from './isEqual-9ec062b5.js';
...
const AssigningRoles = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Heading, "Heading").$$render($$result, { separator: true }, {}, {
    ...
    })} ${escape($users.find((user2) => user2.id === player.userId)?.name)}` : ``} ${validate_component(Button, "Button").$$render($$result, { size: "small", disabled: !$canEdit }, {}, {
      default: () => {
