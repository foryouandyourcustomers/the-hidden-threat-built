import { o as objectEntries } from './index3-b25e75a1.js';
import { g as getGames, d as deleteGame } from './global-b99bb08b.js';
import { g as getGlobalWebSocketServer, s as sendMessageToMachine, a as sendMessageToUsers } from './index4-743f55cf.js';
import { g as getDefaultExportFromCjs } from './_commonjsHelpers-24198af3.js';
import require$$0 from 'events';
import require$$1 from 'fs';
import { A as ActorStatus } from './guards-a76df1b0.js';
import './index-a4865dbd.js';
import './player-85f087dd.js';
import './game-state-ff3d24fc.js';
...
var schedule = /*@__PURE__*/getDefaultExportFromCjs(nodeScheduleExports);
...
const cleanupGames = () => {
  ...
  objectEntries(allGames).forEach(([gameId, game]) => {
    if (
      ...
      game.machine.status === ActorStatus.Stopped || // The game is older than MAX_GAME_DAYS so let's delete it.
      game.machine.getSnapshot().context.timestamp < Date.now() - 1e3 * 60 * 60 * 24 * MAX_GAME_DAYS
    ) {
      deleteGame(gameId);
    }
  });
...
export { handle };
//# sourceMappingURL=hooks.server-f6cf2df6.js.map
