...
import { a as ITEMS, b as isDefenseItemId, c as isAttackItemId } from './constants-36cccee7.js';
...
class GameState {
  ...
  constructor(context) {
    ...
    this.nextEventType = this.lastFinalizedEvent && this.lastFinalizedEvent.type === "move" ? "action" : "move";
