import { c as create_ssr_component, v as validate_component, h as get_store_value, o as onDestroy, l as compute_rest_props, a as subscribe, b as spread, n as escape_attribute_value, d as escape_object, f as add_attribute, e as escape, p as noop, r as set_current_component, t as run_all, u as current_component } from './ssr-0f977c41.js';
import { B as Board, P as PreGameDecoration, C as Check } from './check-5322ef03.js';
import { a as Polygon, P as Paragraph, A as Actions, B as Button } from './Paragraph-714d071c.js';
import { w as writable, d as derived } from './index2-286c48fe.js';
import { a as clone$1, S as SuperFormError, b as clearErrors, d as splitPath, t as traversePath, e as comparePaths, f as setPaths, g as flattenErrors, m as mapErrors, h as errorShape, i as traversePathsAsync, k as traversePaths, p as pathExists, l as isInvalidPath, n as parse } from './forms-78616ad6.js';
import { p as page } from './stores-828decd9.js';
import { B as BROWSER } from './prod-ssr-7cc47430.js';
import { s as stringify } from './stringify-f45e10e0.js';
...
const Checkbox = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let boolValue;
  let $$restProps = compute_rest_props($$props, ["form", "field"]);
  let $boolValue, $$unsubscribe_boolValue = noop, $$subscribe_boolValue = () => ($$unsubscribe_boolValue(), $$unsubscribe_boolValue = subscribe(boolValue, ($$value) => $boolValue = $$value), boolValue);
...
const TextInput = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_value();
  return `<label class="svelte-hpvgb9"><span class="display-name">${slots.default ? slots.default({}) : ``}</span> <input${spread(
    [
      { name: escape_attribute_value(field) },
      { type: "text" },
      {
    ...
    { classes: "svelte-hpvgb9" }
  )}${add_attribute("value", $value, 0)}></label> ${$errors ? `<span class="invalid svelte-hpvgb9">${escape($errors)}</span>` : ``}`;
});
const css = {
  code: "form.svelte-dblyeg{width:44rem}.field.svelte-dblyeg{background:var(--color-blue-transp-760);border-radius:var(--radius-md);margin-bottom:2rem;padding:1rem 2rem}.backdrop.svelte-dblyeg{bottom:var(--size-game-footer-height);left:0;overflow:hidden;pointer-events:none;position:absolute;right:0;top:var(--size-header-height);z-index:-1}.backdrop.svelte-dblyeg svg{bottom:-12%;position:absolute;right:-5%;rotate:-15deg;width:32rem;z-index:-1}.more-info.svelte-dblyeg{margin-top:3rem}",
  map: null
};
const UsernameScreen = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  $$result.css.add(css);
  return `${validate_component(Board, "Board").$$render($$result, { paddedContent: true, showFooter: true }, {}, {
    header: () => {
      return `${validate_component(PreGameDecoration, "PreGameDecoration").$$render($$result, { slot: "header" }, {}, {})}`;
    },
    default: () => {
      return `<div class="backdrop svelte-dblyeg">${validate_component(Polygon, "Polygon").$$render($$result, { color: "black" }, {}, {})}</div> ${validate_component(Heading, "Heading").$$render($$result, { separator: true }, {}, {
        info: () => {
          return `Schritt 1 von 3`;
        },
        default: () => {
          return `Username vergeben`;
        }
    ...
    Usernamen werden Sie in die Lobby geleitet.`;
      ...
      })} <form method="post" class="svelte-dblyeg"><div class="field svelte-dblyeg">${validate_component(Heading, "Heading").$$render($$result, { centered: true }, {}, {
        default: () => {
          return `Dein Username`;
        }
      })} ${validate_component(Paragraph, "Paragraph").$$render($$result, {}, {}, {
        default: () => {
          return `Bitte gib Dir einen Username mit maximal 20 Buchstaben.`;
        }
        ...
        {},
        {}
      )}</div> ${validate_component(Checkbox, "Checkbox").$$render($$result, { form, field: "acceptedTos" }, {}, {
        default: () => {
          return `Hiermit stimme ich der Speicherung meiner eingegebenen Daten zu und bestätige dass ich
      mindestens 18 Jahre alt bin.*`;
        }
      })} ${validate_component(Actions, "Actions").$$render($$result, {}, {}, {
        default: () => {
          return `${validate_component(Button, "Button").$$render($$result, { type: "submit", primary: true }, {}, {
            default: () => {
              return `Bestätigen und weiter`;
            }
          })}`;
        }
      })}</form> <p class="more-info text-sm svelte-dblyeg" data-svelte-h="svelte-1iim19c">* Weitere Informationen zum Spiel sind auf unserer <a href="/">Website</a> zufinden.</p>`;
    }
  })}`;
});

export { UsernameScreen as U };
//# sourceMappingURL=UsernameScreen-397d603a.js.map
