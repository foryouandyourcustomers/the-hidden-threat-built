...
import { c as createMachine, i as interpret, a as assign } from './xstate.esm-3f8dde68.js';
...
const Game = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  $$unsubscribe_section();
  return `<div class="game-wrapper svelte-yumm1n"> <div class="game svelte-yumm1n"${add_attribute("this", gameContainer, 0)}><div class="name svelte-yumm1n" data-svelte-h="svelte-iqe0dn">The Hidden Threat</div> <div class="characters svelte-yumm1n"></div> <div class="items svelte-yumm1n">${slots.items ? slots.items({}) : ``}</div> <div class="actions svelte-yumm1n">${slots.actions ? slots.actions({}) : ``}</div> <div class="content svelte-yumm1n">${$section === "Lobby" ? `${validate_component(Lobby, "Lobby").$$render($$result, {}, {}, {})}` : `...`}</div> ${slots["cursor-overlays"] ? slots["cursor-overlays"]({}) : ``}</div> </div>`;
});
let howl;
const sprite = {
  capture: [0, 204],
