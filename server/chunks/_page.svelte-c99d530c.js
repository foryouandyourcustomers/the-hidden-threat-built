import { c as create_ssr_component, a as subscribe, e as escape, v as validate_component, o as onDestroy, s as setContext, g as each, h as add_styles, f as add_attribute, i as getContext, b as spread, d as escape_object, j as createEventDispatcher, k as compute_slots, l as escape_attribute_value } from './ssr-287f4da9.js';
import { r as readable, w as writable } from './index2-252442cc.js';
import { g as require_root, J as require_baseGetTag, p as requireIsObjectLike, c as requireIsObject, x as createMachine, H as interpret, y as assign, K as not, G as GameState, L as and, B as sharedGuards, I as isEqual, M as getUser, N as getPlayer, O as isActionEventOf, P as BOARD_SUPPLY_CHAINS, E as isDefenderId, Q as BOARD_ITEMS, R as objectEntries, D as getPlayerSide } from './xstate.esm-a503d667.js';
import { A as Actions$1, P as Paragraph, a as Polygon } from './Polygon-064be3f3.js';
import { B as Button } from './Button-63a9c640.js';
import { H as Heading } from './Heading-086dbf37.js';
import { F as Face } from './Face-0c248d08.js';
import { i as isItemIdOfSide, a as isAttackItemId } from './items-ba2c7988.js';
import { I as Item } from './Item-03492e46.js';
...
const css$s = {
  code: ".expandable.svelte-4gxpdc.svelte-4gxpdc{color:#000;isolation:isolate;position:relative;z-index:var(--layer-5)}.expandable.svelte-4gxpdc .icon.svelte-4gxpdc{align-content:center;background:#fff;border-radius:var(--radius-full);display:grid;height:1.5rem;justify-content:center;padding:.25rem;place-content:center;width:1.5rem}.expandable.svelte-4gxpdc .icon.svelte-4gxpdc svg{display:block;height:100%;width:100%}.expandable.svelte-4gxpdc .close.svelte-4gxpdc{padding:0}.expandable.svelte-4gxpdc .content.svelte-4gxpdc{--_padding:0.25rem;align-items:center;background:#fff;border-radius:var(--radius-full);display:flex;gap:1rem;height:2rem;height:calc(1.5rem + var(--_padding)*2);padding:.25rem;padding:var(--_padding);position:absolute;right:-.25rem;right:calc(0px - var(--_padding));top:-.25rem;top:calc(0px - var(--_padding))}",
  map: null
};
const ExpandableButton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$s);
  return `<div class="${["expandable svelte-4gxpdc", ""].join(" ").trim()}"><button class="unstyled icon svelte-4gxpdc">${slots.icon ? slots.icon({}) : ``}</button> ${``} </div>`;
});
...
const css$r = {
  code: "button.svelte-1e1bzpr{height:1.5rem;width:1.5rem}button.svelte-1e1bzpr svg{display:block;height:100%;width:100%}",
  map: null
};
const IconButton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<button class="unstyled svelte-1e1bzpr" ${disabled ? "disabled" : ""}>${slots.default ? slots.default({}) : ``}</button>`;
});
const RollbackButton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$isAdmin ? `${validate_component(IconButton, "ExpandableIconButton").$$render($$result, { disabled: !$lastGameEvent }, {}, {
    default: () => {
      return `${validate_component(Chevron_left, "BackIcon").$$render($$result, {}, {}, {})}`;
    }
  })}` : ``}`;
});
...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="header svelte-7tzkuk"><div class="title svelte-7tzkuk" data-svelte-h="svelte-xbe4by">The hidden threat</div> ${validate_component(EmojiPicker, "EmojiPicker").$$render($$result, {}, {}, {})} <div class="actions svelte-7tzkuk">${validate_component(ExpandableButton, "ExpandableButton").$$render($$result, {}, {}, {
    icon: () => {
...
const css$6 = {
  code: ".square.svelte-dgabf9.svelte-dgabf9{--_inactive-opacity:0;display:block;grid-column:var(--_column);grid-row:var(--_row);isolation:isolate;margin:calc(var(--px)/2);outline:1px dashed #fff;position:relative}.square.svelte-dgabf9.svelte-dgabf9,.square.svelte-dgabf9>.svelte-dgabf9{min-height:0;min-width:0}.move-button.svelte-dgabf9.svelte-dgabf9{background:transparent;bottom:0;cursor:pointer;display:block;left:0;position:absolute;right:0;top:0;transition:background .3s ease-out}.move-button.svelte-dgabf9 span.svelte-dgabf9{display:none}.move-button.svelte-dgabf9.svelte-dgabf9:hover{background:hsla(0,0%,100%,.133);transition-duration:0ms}",
  map: null
};
const Square = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="square svelte-dgabf9"${add_styles({
    "--_row": coordinate[1] + 1,
    "--_column": coordinate[0] + 1
  })}>${validate_component(Stage_1, "Stage").$$render($$result, { coordinate }, {}, {})} ${validate_component(Items, "Items").$$render($$result, { coordinate }, {}, {})} ${validate_component(Players$1, "Players").$$render($$result, { coordinate }, {}, {})} ${$canMove && $isPossibleMove ? `<button class="move-button unstyled svelte-dgabf9" data-svelte-h="svelte-1xw0taw"><span class="svelte-dgabf9">Move</span></button>` : ``} ${$canPlace && $isPossiblePlacement ? `<button class="move-button unstyled svelte-dgabf9" data-svelte-h="svelte-4t2lbw"><span class="svelte-dgabf9">Place</span></button>` : ``} </div>`;
});
const css$5 = {
  code: ".board.svelte-168mze{grid-gap:0;display:grid;gap:0;grid-template-columns:repeat(var(--column-count),1fr);grid-template-rows:repeat(var(--row-count),1fr);height:var(--board-height);margin:0 auto;position:relative;width:var(--board-width)}",
  map: null
};
const Board = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$5);
  return `<div class="board svelte-168mze">${validate_component(Backdrop, "Backdrop").$$render($$result, {}, {}, {})} ${validate_component(StageLines, "StageLines").$$render($$result, {}, {}, {})} ${each([...new Array(ROW_COUNT)], (_, y) => {
    return `${each([...new Array(COLUMN_COUNT)], (_2, x) => {
      return `${validate_component(Square, "Square").$$render($$result, { coordinate: [x, y] }, {}, {})}`;
    })}`;
  })} ${validate_component(Dimming, "Dimming").$$render($$result, {}, {}, {})} </div>`;
});
const css$4 = {
  code: ".players-container.svelte-np1pb5{flex:1;margin-left:1rem;margin-right:1rem}h3.svelte-np1pb5{margin-bottom:1rem;margin-top:0}.players.svelte-np1pb5{display:flex;flex-wrap:wrap;gap:1rem}",
  map: null
};
const Players = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="players-container svelte-np1pb5"><h3 class="svelte-np1pb5" data-svelte-h="svelte-1krh9a0">Verteidiger:innen</h3> <div class="players svelte-np1pb5">${each($defensePlayers, (player) => {
  ...
  })}</div> <h3 class="svelte-np1pb5" data-svelte-h="svelte-1fki2a7">Angreifer:innen</h3> <div class="players svelte-np1pb5">${each($attackPlayers, (player) => {
    let user = getUserForPlayer(player, $users);
    return ` ${validate_component(Player, "Player").$$render(
      $$result,
      {
...
//# sourceMappingURL=_page.svelte-c99d530c.js.map
