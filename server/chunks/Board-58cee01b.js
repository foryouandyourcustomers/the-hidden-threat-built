...
const css$1 = {
  code: '.header.svelte-qfojfz{align-items:center;background-color:var(--color-blue-spielbrett);background:linear-gradient(180deg,rgba(43,52,72,0),rgba(43,52,72,.663));display:grid;grid-template-areas:"logo score jokers options";grid-template-columns:38rem 22rem 1fr auto;height:var(--size-header-height);overflow:hidden;padding-left:7rem;padding-right:1rem}.header.svelte-qfojfz,.title.svelte-qfojfz{position:relative}.title.svelte-qfojfz{align-self:start;font-family:var(--font-display);font-size:var(--scale-4);grid-area:logo;line-height:2.5rem;text-transform:uppercase}.backdrop.svelte-qfojfz{height:3.3125rem;left:1.875rem;position:absolute;top:0;width:21.625rem}',
  map: null
};
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$1);
  return `<div class="header svelte-qfojfz"><div class="backdrop svelte-qfojfz" data-svelte-h="svelte-17ojy9"><svg width="346" height="53" viewBox="0 0 346 53" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M45 0H0l54 53-9-53Z" fill="#F03A50"></path><path d="M45 0h33L54 53 45 0Z" fill="#A40224"></path><path d="M346 38 330 0H78L54 53l292-15Z" fill="#D32746"></path></svg></div> <div class="title svelte-qfojfz" data-svelte-h="svelte-xbe4by">The hidden threat</div> ${slots.default ? slots.default({}) : ``} </div>`;
});
const css = {
...
//# sourceMappingURL=Board-58cee01b.js.map
