import { c as create_ssr_component, e as escape, v as validate_component, f as add_attribute, z as null_to_empty } from './ssr-53fe64ef.js';
import { i as is_void } from './Heading-e9ca207e.js';
...
const css$1 = {
  code: ".button.svelte-19mv2es{--_padding-inline:1.5rem;--_scale:var(--scale-2);--_color-text:var(--color-text);--_color-bg:transparent;--_color-bg-hover:var(--color-blue-transparent);--_color-border:var(--color-border);--_radius:var(--radius-full);--_height:3rem;align-items:center;background-color:transparent;background-color:var(--_color-bg);border:.125rem solid var(--_color-border);border-radius:var(--radius-full);border-radius:var(--_radius);color:var(--color-text);color:var(--_color-text);cursor:pointer;display:inline-flex;font-family:BarlowCondensed,sans-serif;font-size:var(--scale-2);font-size:var(--_scale);font-weight:var(--weight-semibold);gap:.5em;height:3rem;height:var(--_height);justify-content:center;padding-left:1.5rem;padding-left:var(--_padding-inline);padding-right:1.5rem;padding-right:var(--_padding-inline);-webkit-text-decoration:none;text-decoration:none;text-transform:uppercase;white-space:nowrap}.button.svelte-19mv2es:hover:not([disabled]){background-color:var(--_color-bg-hover);box-shadow:0 0 6px var(--color-shadow)}.button.primary.svelte-19mv2es{--_color-bg:var(--color-bg-strong);--_color-bg-hover:var(--color-bg-strong);--_color-text:var(--color-text-onstrong);--_color-border:transparent}.button.inverse.svelte-19mv2es{--_color-bg:var(--color-bg);--_color-bg-hover:var(--color-bg-secondary);--_color-text:var(--color-text);--_color-border:transparent}.button.big.svelte-19mv2es{--_height:3rem;--_padding-inline:1.5rem}.button.small.svelte-19mv2es{--_height:2.5rem;--_padding-inline:1.5rem}.button[disabled].svelte-19mv2es{--_color-text:var(--color-text-disabled);cursor:not-allowed;opacity:.6;pointer-events:none}.button.primary[disabled].svelte-19mv2es{--_color-text:var(--color-text-disabled-onstrong);--_color-bg:var(--color-bg-disabled-strong);--_color-border:transparent}.button.svelte-19mv2es:focus-visible{outline:3px solid hsla(0,0%,100%,.533)}",
  map: null
};
      ...
      default: () => {
        return `${((tag) => {
          return tag ? `<${href ? "a" : "button"} role="button"${add_attribute("tabindex", tabIndex, 0)} class="${[
            escape(null_to_empty(`button ${size}`), true) + " svelte-19mv2es",
...
//# sourceMappingURL=Paragraph-885106f7.js.map
