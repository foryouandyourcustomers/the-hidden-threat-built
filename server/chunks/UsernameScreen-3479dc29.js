import { c as create_ssr_component, v as validate_component, h as get_store_value, o as onDestroy, p as compute_rest_props, a as subscribe, b as spread, q as escape_attribute_value, d as escape_object, f as add_attribute, e as escape, n as noop, r as set_current_component, t as run_all, u as current_component } from './ssr-53fe64ef.js';
import { B as Board } from './Board-adc54976.js';
import { P as Paragraph, A as Actions, B as Button } from './Paragraph-885106f7.js';
import { w as writable, d as derived } from './index2-19ef3658.js';
...
const css$1 = {
  code: "label.svelte-h52x4k{margin-bottom:.5rem;margin-top:.5rem}input.svelte-h52x4k,label.svelte-h52x4k{display:block}input.svelte-h52x4k{background:var(--color-blue-spielbrett);border:1px solid var(--color-grey-300);border-radius:var(--radius-md);height:2.5rem;min-width:18rem;padding-left:.75rem;padding-right:.75rem;width:100%}input.svelte-h52x4k:focus-visible{outline:3px solid hsla(0,0%,100%,.533)}.invalid.svelte-h52x4k{color:#cd5c5c}",
  map: null
};
const TextInput = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_value();
  return `<label class="svelte-h52x4k"><span class="display-name">${slots.default ? slots.default({}) : ``}</span> <input${spread(
    [
      { name: escape_attribute_value(field) },
      { type: "text" },
      {
    ...
    { classes: "svelte-h52x4k" }
  )}${add_attribute("value", $value, 0)}></label> ${$errors ? `<span class="invalid svelte-h52x4k">${escape($errors)}</span>` : ``}`;
});
const css = {
  code: "form.svelte-fhfcdl{width:44rem}.field.svelte-fhfcdl{background:var(--color-blue-transp-760);padding:1rem 2rem}",
  map: null
};
const UsernameScreen = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  $$result.css.add(css);
  return `${validate_component(Board, "Board").$$render($$result, { paddedContent: true }, {}, {
    default: () => {
    ...
    Usernamen werden Sie in die Lobby geleitet.`;
      ...
      })} <form method="post" class="svelte-fhfcdl"><div class="field svelte-fhfcdl">${validate_component(Heading, "Heading").$$render($$result, { centered: true }, {}, {
        default: () => {
...
//# sourceMappingURL=UsernameScreen-3479dc29.js.map
