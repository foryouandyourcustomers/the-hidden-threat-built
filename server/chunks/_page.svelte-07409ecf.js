...
import { I as Item } from './Item-7c34e484.js';
...
const css$k = {
  code: "button.svelte-1ilpb8r{display:block;padding:.5rem 1rem;text-align:left;white-space:nowrap;width:100%}button.svelte-1ilpb8r:hover{background:rgba(213,217,227,.302)}",
  map: null
};
const Action = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<button class="unstyled svelte-1ilpb8r" ${disabled ? "disabled" : ""}>${slots.default ? slots.default({}) : ``} </button>`;
});
const CollectItem = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Action, "Action").$$render($$result, { disabled: $collectableItems.length === 0 }, {}, {
    default: () => {
      return `Gegenstand einsammeln`;
    }
  })} ${$startedCollecting ? `${validate_component(GameDialog, "GameDialog").$$render($$result, { title: "Gegenstand einsammeln" }, {}, {
    default: () => {
      return `${validate_component(Paragraph, "Paragraph").$$render($$result, {}, {}, {
        default: () => {
          return `Klicke auf den Gegenstand den du einsammeln möchtest`;
        }
      })} ${each($collectableItems, (collectableItem) => {
        return `<button class="unstyled">${validate_component(Item, "Item").$$render($$result, { itemId: collectableItem.item.id }, {}, {})} </button>`;
      })}`;
    }
  })}` : ``}`;
});
const AttackStage = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let $startedAttacking, $$unsubscribe_startedAttacking;
  const { machine: machine2 } = getGameContext();
  ...
  const startedAttacking = useSelector(machine2.service, ({ context }) => {
    const gameState = GameState.fromContext(context);
    return isActionEventOf(gameState.lastEvent, "attack");
  });
  $$unsubscribe_startedAttacking = subscribe(startedAttacking, (value) => $startedAttacking = value);
  $$unsubscribe_attackableStages();
  $$unsubscribe_startedAttacking();
  return `${validate_component(Action, "Action").$$render($$result, { disabled: !$attackableStages.length }, {}, {
    default: () => {
      return `Stufe angreifen`;
    }
  })} ${$startedAttacking ? `${validate_component(GameDialog, "GameDialog").$$render($$result, { title: "Stufe angreifen" }, {}, {
    default: () => {
      return `${validate_component(Paragraph, "Paragraph").$$render($$result, {}, {}, {
        default: () => {
          return `Möchtest du folgende Gegenstände einsetzen um die Stufe anzugreifen?`;
        }
      })} ${each($attackableStages, (stage) => {
        return `<button>${escape(stage.id)}</button>`;
      })}`;
    }
  })}` : ``}`;
});
const DefendStage = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_startedDefending = subscribe(startedDefending, (value) => $startedDefending = value);
  $$unsubscribe_canDefend();
  $$unsubscribe_startedDefending();
  return `${validate_component(Action, "Action").$$render($$result, { disabled: !$canDefend }, {}, {
    default: () => {
      return `Stufe verteidigen`;
    }
  })} ${$startedDefending ? `${validate_component(GameDialog, "GameDialog").$$render($$result, { title: "Stufe verteidigen" }, {}, {
    default: () => {
      return `${validate_component(Paragraph, "Paragraph").$$render($$result, {}, {}, {
        default: () => {
...
const css$j = {
  code: ".actions.svelte-1u4230i.svelte-1u4230i{left:calc(11.11111%*(var(--x)));position:absolute;top:calc(12.5%*(var(--y)))}.actions.svelte-1u4230i ul.svelte-1u4230i{background:#fff;border-radius:var(--radius-sm);color:#000;font-size:var(--scale-00);list-style-type:none;margin:0;min-width:15rem;overflow:hidden;padding:0;position:absolute}.actions.svelte-1u4230i ul li.title.svelte-1u4230i{box-shadow:0 0 .5rem rgba(0,0,0,.2);padding:.5rem 1rem}.actions.svelte-1u4230i ul.svelte-1u4230i:not(.on-left){left:calc(var(--board-square-size) + .3rem)}.actions.svelte-1u4230i ul.on-left.svelte-1u4230i{right:.3rem}.actions.svelte-1u4230i ul.svelte-1u4230i:not(.on-top){top:.3rem}.actions.svelte-1u4230i ul.on-top.svelte-1u4230i{bottom:calc(0px - var(--board-square-size) + .3rem)}",
  map: null
};
const Actions = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_side();
  return `${$canPerformAction ? `<div class="actions svelte-1u4230i"${add_styles({
    "--x": $activePlayerPosition[0],
    "--y": $activePlayerPosition[1]
  })}><ul class="${[
    "svelte-1u4230i",
    ($activePlayerPosition[0] > 5 ? "on-left" : "") + " " + ($activePlayerPosition[1] > 4 ? "on-top" : "")
  ].join(" ").trim()}"><li class="title svelte-1u4230i" data-svelte-h="svelte-axnyp8">Aktion auswählen</li> <li>${validate_component(CollectItem, "CollectItem").$$render($$result, {}, {}, {})}</li> <li>${$side === "attack" ? `${validate_component(AttackStage, "AttackStage").$$render($$result, {}, {}, {})}` : `${validate_component(DefendStage, "DefendStage").$$render($$result, {}, {}, {})}`}</li></ul></div>` : ``}`;
});
const css$i = {
...
const AttackedIcon = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<svg viewBox="0 0 48 48" width="48" height="48" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="24" cy="24" r="24" fill="#F03A50"></circle><path d="M10 24h28" stroke="#fff" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"></path></svg>`;
});
const DefendedIcon = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<svg viewBox="0 0 48 48" width="48" height="48" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="24" cy="24" r="24" fill="#B5BF39"></circle><path d="m12 24 8 8 16-16" stroke="#fff" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"></path></svg>`;
});
const css$e = {
...
const css$9 = {
  code: ".square.svelte-1b9guc0.svelte-1b9guc0{--_inactive-opacity:0;display:block;grid-column:var(--_column);grid-row:var(--_row);isolation:isolate;position:relative}.square.svelte-1b9guc0.svelte-1b9guc0,.square.svelte-1b9guc0>.svelte-1b9guc0{min-height:0;min-width:0}.move-button.svelte-1b9guc0.svelte-1b9guc0{background:transparent;bottom:0;cursor:pointer;display:block;left:0;position:absolute;right:0;top:0;transition:background .3s ease-out;z-index:var(--layer-top)}.move-button.svelte-1b9guc0 span.svelte-1b9guc0{display:none}.move-button.svelte-1b9guc0.svelte-1b9guc0:hover{background:hsla(0,0%,100%,.133);transition-duration:0ms}.status.svelte-1b9guc0.svelte-1b9guc0{align-content:center;background-color:color-mix(in oklab,var(--color-blue-spielbrett),transparent 20%);bottom:0;display:grid;justify-content:center;left:0;place-content:center;pointer-events:none;position:absolute;right:0;top:0}",
  map: null
};
const Square = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="square svelte-1b9guc0"${add_styles({
    "--_row": coordinate[1] + 1,
    "--_column": coordinate[0] + 1
  })}>${validate_component(Stage_1, "Stage").$$render($$result, { coordinate }, {}, {})} ${validate_component(Items, "Items").$$render($$result, { coordinate }, {}, {})} ${validate_component(Players$1, "Players").$$render($$result, { coordinate }, {}, {})} ${$canMove && $isPossibleMove ? `<button class="move-button unstyled svelte-1b9guc0" data-svelte-h="svelte-1xw0taw"><span class="svelte-1b9guc0">Move</span></button>` : ``} ${$canPlace && $isPossiblePlacement ? `<button class="move-button unstyled svelte-1b9guc0" data-svelte-h="svelte-4t2lbw"><span class="svelte-1b9guc0">Place</span></button>` : ``} ${$isDefended || $isAttacked ? `<div class="status svelte-1b9guc0">${$isDefended ? `${validate_component(DefendedIcon, "DefendedIcon").$$render($$result, {}, {}, {})}` : `${$isAttacked ? `${validate_component(AttackedIcon, "AttackedIcon").$$render($$result, {}, {}, {})}` : ``}`}</div>` : ``} </div>`;
});
const css$8 = {
...
const css$5 = {
  code: "button.svelte-1rq1kql.svelte-1rq1kql{text-wrap:nowrap;align-items:center;border-radius:var(--radius-xs);color:#fff;display:flex;flex-direction:column;flex-shrink:0;font-size:var(--scale-0000);font-weight:700;height:5.25rem;isolation:isolate;justify-content:flex-end;padding:.5rem 0;position:relative;text-align:center;width:3.625rem}button.svelte-1rq1kql svg{bottom:auto;left:.25rem;position:absolute;right:.25rem;top:.75rem;z-index:-1}button.svelte-1rq1kql span.svelte-1rq1kql{display:block}button.attack.svelte-1rq1kql.svelte-1rq1kql{background-color:var(--color-red-polygon)}button.defense.svelte-1rq1kql.svelte-1rq1kql{background-color:var(--color-orange-dark)}button.selected.svelte-1rq1kql.svelte-1rq1kql{box-shadow:0 0 8px 0 rgba(88,90,90,.4);height:5.875rem;width:4rem}",
  map: null
};
const AttackCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<button ${disabled ? "disabled" : ""} class="${[
    "unstyled " + escape(side, true) + " svelte-1rq1kql",
    selected ? "selected" : ""
    ...
    {},
    {}
  )} <span class="svelte-1rq1kql">${slots.default ? slots.default({}) : ``}</span> </button>`;
});
const css$4 = {
  code: ".scenarios.svelte-1rk2id7.svelte-1rk2id7{display:flex;flex-direction:column;height:100%}.description.svelte-1rk2id7.svelte-1rk2id7{flex:1}.attacks.svelte-1rk2id7.svelte-1rk2id7{align-items:flex-end;display:flex;gap:1rem;list-style:none;margin:0;overflow-x:scroll;padding:0;width:100%}.targets.svelte-1rk2id7.svelte-1rk2id7{display:flex;gap:2rem}.targets.svelte-1rk2id7 .stage.svelte-1rk2id7{font-size:.75rem}.targets.svelte-1rk2id7 .items.svelte-1rk2id7{display:flex;gap:.5rem}",
  map: null
};
const GlobalAttacks = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const globalAttackScenario = useSelector(machine2.service, (state) => GameState.fromContext(state.context).globalAttackScenario, isEqual);
  ...
  return `<div class="scenarios svelte-1rk2id7"><div class="description svelte-1rk2id7">${validate_component(Paragraph, "Paragraph").$$render($$result, { spacing: "none", size: "sm" }, {}, {
    default: () => {
      return `Allgemeiner Angriff`;
    }
  })} ${!selectedAttack ? `${validate_component(Paragraph, "Paragraph").$$render($$result, {}, {}, {
    default: () => {
      return `${escape($globalAttackScenario.description)}`;
    }
  })}` : `${validate_component(Heading, "Heading").$$render($$result, { size: "sm", spacing: "none" }, {}, {
    default: () => {
  ...
  })} ${validate_component(Heading, "Heading").$$render($$result, { size: "xs", spacing: "none" }, {}, {
    default: () => {
      return `Benötigte Gegenstände`;
    }
  })} <div class="targets svelte-1rk2id7">${each(selectedAttack.targets, (target) => {
    let stage = getStage(target.stageId);
    return ` <div class="target"><div class="stage svelte-1rk2id7">${escape(stage.name)}</div> <div class="items svelte-1rk2id7">${each(stage.defenseItems, (item) => {
      return `${validate_component(Item, "Item").$$render($$result, { itemId: item }, {}, {})}`;
    })}</div> </div>`;
  })}</div>`}</div> <ul class="attacks svelte-1rk2id7"><li>${validate_component(AttackCard, "AttackCard").$$render(
    $$result,
    {
      side: "defense",
  ...
  )}</li> ${each($globalAttackScenario.attacks, (_, index) => {
...
const css$3 = {
  code: ".scenarios.svelte-1jjgz7e.svelte-1jjgz7e{display:flex;flex-direction:column;height:100%}.description.svelte-1jjgz7e.svelte-1jjgz7e{flex:1}.attacks.svelte-1jjgz7e.svelte-1jjgz7e{align-items:flex-end;display:flex;gap:1rem;list-style:none;margin:0;overflow-x:scroll;padding:0;width:100%}.targets.svelte-1jjgz7e.svelte-1jjgz7e{display:flex;gap:2rem}.targets.svelte-1jjgz7e .items.svelte-1jjgz7e{display:flex;gap:.5rem}",
  map: null
};
const TargetedAttacks = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const { machine: machine2 } = getGameContext();
  const activeAttacks = useSelector(machine2.service, (state) => GameState.fromContext(state.context).activeTargetedAttacks, isEqual);
  ...
  return `<div class="scenarios svelte-1jjgz7e"><div class="description svelte-1jjgz7e">${validate_component(Paragraph, "Paragraph").$$render($$result, { spacing: "none", size: "sm" }, {}, {
    default: () => {
      return `Gezielter Angriff`;
    }
  })} ${validate_component(Heading, "Heading").$$render($$result, { size: "sm", spacing: "none" }, {}, {
    default: () => {
      return `Angriff ${escape(selectedAttackIndex + 1)}`;
  ...
  })} ${escape(selectedAttack.target.supplyChainId)} ${escape(selectedAttack.target.stageId)} ${validate_component(Heading, "Heading").$$render($$result, { size: "xs", spacing: "none" }, {}, {
    default: () => {
      return `Benötigte Gegenstände`;
    }
  })} <div class="targets svelte-1jjgz7e"><div class="target"><div class="items svelte-1jjgz7e">${each(selectedAttack.target.requiredItems, (item) => {
    return `${validate_component(Item, "Item").$$render($$result, { itemId: item }, {}, {})}`;
  })}</div></div></div></div> <ul class="attacks svelte-1jjgz7e">${each(new Array($totalAttackCount), (_, index) => {
    return `<li>${validate_component(AttackCard, "AttackCard").$$render(
      $$result,
      {
        side: "attack",
...
const css$2 = {
  code: ".info-panel.svelte-otb4c7.svelte-otb4c7{display:flex;height:22.5rem;margin-left:.375rem}nav.svelte-otb4c7.svelte-otb4c7{align-items:flex-end;display:flex;flex-direction:column;gap:.25rem}nav.svelte-otb4c7 button.svelte-otb4c7{background-color:var(--color-blue-transp-12);border-radius:var(--radius-md);border-bottom-right-radius:0;border-top-right-radius:0;height:2.5rem;padding:.3125rem;width:2.5rem}nav.svelte-otb4c7 button.active.svelte-otb4c7{background-color:#fff;color:var(--color-blue-spielbrett);height:3.125rem;padding:.625rem;width:3.125rem}nav.svelte-otb4c7 button.svelte-otb4c7 svg{display:block;height:100%;width:100%}.content.svelte-otb4c7.svelte-otb4c7{background-color:#fff;border-radius:var(--radius-md);border-top-left-radius:0;color:var(--color-blue-spielbrett);flex:1;max-width:100%;overflow:hidden;padding:1.25rem}",
  map: null
};
const InfoPanel = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_side();
  return `<div class="info-panel svelte-otb4c7"><nav class="svelte-otb4c7"><button class="${["unstyled svelte-otb4c7", "active"].join(" ").trim()}">${validate_component(AttacksIcon, "AttacksIcon").$$render($$result, {}, {}, {})}</button> <button class="${["unstyled svelte-otb4c7", ""].join(" ").trim()}">${validate_component(InventoryIcon, "InventoryIcon").$$render($$result, {}, {}, {})}</button></nav> <div class="content svelte-otb4c7">${`${$side === "attack" ? `${validate_component(TargetedAttacks, "TargetedAttacks").$$render($$result, {}, {}, {})}` : `${validate_component(GlobalAttacks, "GlobalAttacks").$$render($$result, {}, {}, {})}`}`}</div> </div>`;
});
const css$1 = {
