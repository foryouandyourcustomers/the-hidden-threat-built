...
import { a as ITEMS, i as isDefenseItemId, b as isAttackItemId, F as FACES, C as CHARACTERS } from './constants-3e34656c.js';
...
const CollectItem = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  getGameContext();
  return `<button data-svelte-h="svelte-12h66hs">Collect item</button>`;
});
const css$7 = {
...
const Actions = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const { machine: machine2 } = getGameContext();
  const canPerformAction = useSelector(machine2.service, (state) => state.matches("Playing.Ready for action"));
