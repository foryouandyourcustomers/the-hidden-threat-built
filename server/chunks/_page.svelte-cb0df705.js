...
import { P as Paragraph, A as Actions, B as Button, a as Polygon } from './Polygon-63febb49.js';
...
const css$2 = {
  code: ".card.svelte-1k8k5kv.svelte-1k8k5kv{background:var(--color-bg-secondary);border-radius:var(--radius-md);box-shadow:0 0 25px rgba(28,37,38,.467);overflow:hidden}.card.svelte-1k8k5kv header.svelte-1k8k5kv{align-items:flex-end;background:var(--color-bg);display:flex;height:9rem;justify-content:flex-start}.card.svelte-1k8k5kv .content.svelte-1k8k5kv{padding:1rem}.card.svelte-1k8k5kv h2.svelte-1k8k5kv{background:var(--color-bg-secondary);border-top-right-radius:var(--radius-md);font:var(--display-h3);padding:.5rem 1rem;text-transform:uppercase}.card.svelte-1k8k5kv h3.svelte-1k8k5kv{font:var(--display-h5)}.card.svelte-1k8k5kv p.svelte-1k8k5kv{font:var(--text-regular)}",
  map: null
};
const AnalogGameCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="card svelte-1k8k5kv"><header class="svelte-1k8k5kv"><h2 class="svelte-1k8k5kv">${escape(title)}</h2></header> <div class="content svelte-1k8k5kv"><h3 class="svelte-1k8k5kv">${escape(subtitle)}</h3> <p class="svelte-1k8k5kv">${slots.default ? slots.default({}) : ``}</p> <a${add_attribute("href", downloadLink, 0)}>Download starten</a></div> </div>`;
});
const css$1 = {
...
//# sourceMappingURL=_page.svelte-cb0df705.js.map
