import { c as create_ssr_component, a as subscribe, i as add_styles, e as escape, f as add_attribute, v as validate_component, b as spread, d as escape_object } from './ssr-0f977c41.js';
import { r as readable } from './index2-286c48fe.js';
import { g as getGameContext, u as useSelector } from './game-context-22448513.js';
import { g as getUser } from './user-8b4b9a11.js';
import { F as FooterNav, a as Face } from './Face-01ae0e5d.js';
import { X } from './Paragraph-714d071c.js';

const getCurrentUser = (context) => getUser(context.userId, context);
const css$2 = {
  code: '.header.svelte-164lruu{align-items:center;background:linear-gradient(to bottom,rgba(43,52,72,0),rgba(43,52,72,.663)),linear-gradient(to bottom,var(--color-blue-spielbrett),var(--color-blue-spielbrett));display:grid;grid-template-areas:"logo score jokers options";grid-template-columns:38rem 22rem 1fr auto;height:var(--size-header-height);padding-left:7rem;padding-right:1rem}.header.svelte-164lruu,.title.svelte-164lruu{position:relative}.title.svelte-164lruu{align-self:start;font-family:var(--font-display);font-size:var(--scale-4);grid-area:logo;line-height:2.5rem;text-transform:uppercase}.backdrop.svelte-164lruu{height:3.3125rem;left:1.875rem;position:absolute;top:0;width:21.625rem}',
  map: null
};
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$2);
  return `<div class="header svelte-164lruu"><div class="backdrop svelte-164lruu" data-svelte-h="svelte-17ojy9"><svg width="346" height="53" viewBox="0 0 346 53" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M45 0H0l54 53-9-53Z" fill="#F03A50"></path><path d="M45 0h33L54 53 45 0Z" fill="#A40224"></path><path d="M346 38 330 0H78L54 53l292-15Z" fill="#D32746"></path></svg></div> <div class="title svelte-164lruu" data-svelte-h="svelte-xbe4by">The hidden threat</div> ${slots.default ? slots.default({}) : ``} </div>`;
});
const css$1 = {
...
export { Board as B, Check as C, PreGameDecoration as P, getCurrentUser as g };
//# sourceMappingURL=check-5322ef03.js.map
