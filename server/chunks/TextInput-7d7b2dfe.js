import { h as get_store_value, o as onDestroy, c as create_ssr_component, i as compute_rest_props, a as subscribe, j as spread, k as escape_attribute_value, l as escape_object, d as add_attribute, e as escape, n as noop, p as set_current_component, r as run_all, q as current_component } from './ssr-3cdd5219.js';
import { w as writable, d as derived } from './index2-60faee12.js';
import { p as page } from './stores-57cf8497.js';
import { a as clone$1, S as SuperFormError, b as clearErrors, d as splitPath, t as traversePath, e as comparePaths, f as setPaths, g as flattenErrors, m as mapErrors, h as errorShape, i as traversePathsAsync, k as traversePaths, p as pathExists, l as isInvalidPath, n as parse } from './forms-8702bdb3.js';
...
const css$2 = {
  code: ".centered.svelte-1m2gxp2{align-content:center;display:grid;justify-content:center;min-height:100%;place-content:center}",
  map: null
};
const CenteredContent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$2);
  return `<div class="centered svelte-1m2gxp2">${slots.default ? slots.default({}) : ``} </div>`;
});
...
const css$1 = {
  code: "label.svelte-1mqqb42{display:block;margin-bottom:var(--size-2);margin-top:var(--size-2)}.invalid.svelte-1mqqb42{color:#cd5c5c}",
  map: null
};
const Checkbox = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_errors();
  return `<label class="svelte-1mqqb42"><input${spread(
    [
      { type: "checkbox" },
    ...
    { classes: "svelte-1mqqb42" }
  )}${add_attribute("checked", $boolValue, 1)}> <span class="display-name">${slots.default ? slots.default({}) : ``}</span></label> ${$errors ? `<span class="invalid svelte-1mqqb42">${escape($errors)}</span>` : ``}`;
});
const css = {
  code: "label.svelte-9gemke{margin-bottom:var(--size-2);margin-top:var(--size-2)}input.svelte-9gemke,label.svelte-9gemke{display:block}input.svelte-9gemke{border:1px solid var(--color-grey-300);border-radius:var(--radius-md);height:var(--size-10);min-width:var(--size-72);padding-left:var(--size-3);padding-right:var(--size-3);width:100%}.invalid.svelte-9gemke{color:#cd5c5c}",
  map: null
};
const TextInput = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_value();
  return `<label class="svelte-9gemke"><span class="display-name">${slots.default ? slots.default({}) : ``}</span> <input${spread(
    [
      { name: escape_attribute_value(field) },
      { type: "text" },
      {
    ...
    { classes: "svelte-9gemke" }
  )}${add_attribute("value", $value, 0)}></label> ${$errors ? `<span class="invalid svelte-9gemke">${escape($errors)}</span>` : ``}`;
});

export { CenteredContent as C, TextInput as T, Checkbox as a, superForm as s };
//# sourceMappingURL=TextInput-7d7b2dfe.js.map
