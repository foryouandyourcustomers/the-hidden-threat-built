import { c as create_ssr_component, v as validate_component, e as escape, b as spread, d as escape_object, f as add_attribute } from './ssr-ea380d77.js';
import { S as Section } from './Section-eca688ec.js';
import { P as Paragraph, A as Actions, B as Button, a as Polygon } from './Polygon-70208dc0.js';
...
const css$2 = {
  code: ".card.svelte-12p4nhu.svelte-12p4nhu{background:var(--color-bg-secondary);border-radius:var(--radius-md);box-shadow:0 0 1.75rem rgba(28,37,38,.467);overflow:hidden}.card.svelte-12p4nhu header.svelte-12p4nhu{align-items:flex-end;background-color:var(--color-bg);background:var(--background-image) no-repeat center;background-size:cover;display:flex;height:9rem;justify-content:flex-start}.card.svelte-12p4nhu .content.svelte-12p4nhu{padding:1rem}.card.svelte-12p4nhu h2.svelte-12p4nhu{background:var(--color-bg-secondary);border-top-right-radius:var(--radius-md);font:var(--display-h3);padding:.5rem 1rem;text-transform:uppercase}.card.svelte-12p4nhu h3.svelte-12p4nhu{font:var(--display-h5)}.card.svelte-12p4nhu p.svelte-12p4nhu{font:var(--text-regular)}",
  map: null
};
const AnalogGameCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="card svelte-12p4nhu"><header class="svelte-12p4nhu"><h2 class="svelte-12p4nhu">${escape(title)}</h2></header> <div class="content svelte-12p4nhu"><h3 class="svelte-12p4nhu">${escape(subtitle)}</h3> <p class="svelte-12p4nhu">${slots.default ? slots.default({}) : ``}</p> <a${add_attribute("href", downloadLink, 0)}>Download starten</a></div> </div>`;
});
const css$1 = {
...
//# sourceMappingURL=_page.svelte-084f0030.js.map
