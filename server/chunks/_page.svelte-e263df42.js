...
import { R as ROW_COUNT, C as COLUMN_COUNT, F as FACES, i as isItemIdOfSide, b as CHARACTERS } from './constants-e0597195.js';
...
const css = {
  code: ".game-wrapper.svelte-1w5lkt{align-content:center;background:#000;display:grid;height:100%;justify-content:center;place-content:center;width:100%}.game.svelte-1w5lkt{grid-gap:1rem;background-color:var(--color-bg);border-radius:var(--radius-sm);display:grid;gap:1rem;grid-template-rows:auto 1fr;height:50rem;overflow:hidden;position:relative;width:90rem}.game.section-playing.svelte-1w5lkt{background-image:url(/images/board-backdrop.svg);background-repeat:no-repeat;background-size:cover}@media(max-width:1439.98px) or (max-height:809.98px){.game.svelte-1w5lkt{scale:.8;transform-origin:center}}@media(max-width:1199.98px) or (max-height:674.98px){.game.svelte-1w5lkt{scale:.6}}.content.svelte-1w5lkt{padding-right:3rem}",
  map: null
};
