...
import { g as require_root, I as require_baseGetTag, p as requireIsObjectLike, c as requireIsObject, x as createMachine, F as interpret, y as assign, J as not, G as GameState, K as and, B as sharedGuards, H as isEqual, L as getUser, M as getPlayer, D as isDefenderId } from './xstate.esm-36fb69d9.js';
...
import { F as FACES, i as isItemIdOfSide, C as CHARACTERS } from './constants-36cccee7.js';
...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="header svelte-jnmtxx"><div class="title svelte-jnmtxx" data-svelte-h="svelte-xbe4by">The hidden threat</div> ${validate_component(RollbackButton, "RollbackButton").$$render($$result, {}, {}, {})} ${validate_component(EmojiPicker, "EmojiPicker").$$render($$result, {}, {}, {})} </div>`;
});
const css$h = {
...
const css$7 = {
  code: ".actions.svelte-oiwzb{background:var(--color-bg);left:50%;list-style-type:none;padding:1rem;position:absolute;top:50%}",
  map: null
};
const Actions = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$canPerformAction ? `<ul class="actions svelte-oiwzb"><li>${validate_component(CollectItem, "CollectItem").$$render($$result, {}, {}, {})}</li></ul>` : ``}`;
});
const css$6 = {
...
const Square = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const players = useSelector(
    ...
    ({ context }) => {
      ...
      return objectEntries(playerPositions).filter(([_, position]) => isEqual(position, coordinate)).map(([playerId]) => getPlayer(playerId, context));
    },
    isEqual
  );
  $$unsubscribe_players = subscribe(players, (value) => $players = value);
...
const Board = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="board svelte-1hmvwcc"${add_styles({
    ...
    "--row-count": rowCount
  })}>${validate_component(Backdrop, "Backdrop").$$render($$result, {}, {}, {})} ${each([...new Array(rowCount)], (_, x) => {
    return `${each([...new Array(columnCount)], (_2, y) => {
...
//# sourceMappingURL=_page.svelte-1a36c3c3.js.map
