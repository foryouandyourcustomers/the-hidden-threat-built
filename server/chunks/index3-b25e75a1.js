...
const getGameSummaryFilename = (context) => {
  const date = new Date(context.timestamp);
  return `game-data-${format(date, "yyyy-LL-dd")}.json`;
};

export { isEqual$1 as A, findStageAt as B, produce as C, envBool as D, getGameSummaryFilename as E, getGameSummary as F, GLOBAL_ATTACK_SCENARIOS as G, require_baseGetTag as H, getStageAt as I, getStage as J, BOARD_ITEMS as K, BOARD_SUPPLY_CHAINS as L, throwIfNotFound as M, seededRandomGenerator as N, STAGES as S, TARGETED_ATTACKS as T, requireIsArray as a, require_getNative as b, requireEq as c, requireIsObject as d, require_isPrototype as e, require_arrayLikeKeys as f, getSharedGameContext as g, requireIsArrayLike as h, require_root as i, require_getSymbols as j, require_overArg as k, require_arrayPush as l, requireStubArray as m, require_baseGetAllKeys as n, objectEntries as o, require_Uint8Array as p, require_Symbol as q, requireKeys as r, require_getTag as s, requireIsObjectLike as t, require_nodeUtil as u, require_baseUnary as v, require_Stack as w, require_getAllKeys as x, requireIsBuffer as y, setAutoFreeze as z };
//# sourceMappingURL=index3-b25e75a1.js.map
